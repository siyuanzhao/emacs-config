...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (switch-window golden-ratio god-mode helm popwin magit tangotango-theme smex jedi swiper auto-complete paradox ein request websocket easy-kill)))
...
;;config for switch-window
(global-set-key (kbd "M-p") 'switch-window)
;; fix for golden ratio not active when switch-window
(add-hook 'buffer-list-update-hook #'golden-ratio) 
(add-hook 'focus-in-hook           #'golden-ratio)
(add-hook 'focus-out-hook          #'golden-ratio)
